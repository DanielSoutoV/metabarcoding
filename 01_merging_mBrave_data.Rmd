...
#here we have the dataset BUT we have to rename the BINs according to the previous format I used. I am doing vlookup function in excel using the data/finaldat_merged.csv file. NOTE, not the one from Final_anal
...
tradmeta_toMerge %>% group_by(bold_bin) %>% filter(n()>1) #see below, there are 332 Bins which are duplicated. Check in Excel
