...
sample <- read.csv('data/final_anal/metadata_trad_metabr_parallel.csv', header = TRUE)

all_dat <- read.csv('data/final_anal/tradmetabrparallel_final.csv', header = TRUE)
