...
with(metadata_samples, ordiellipse(arthro_all.nmds, methodClass,draw =  'polygon',col = c('firebrick4'),
                                  show.groups =(c("trad"))))
with(metadata_samples, ordiellipse(arthro_all.nmds, methodClass, draw =  'polygon', col = c('darkolivegreen'), 
                                  show.groups =(c("metabr"))))
with(metadata_samples, ordiellipse(arthro_all.nmds, methodClass, draw =  'polygon', col = c('darkorchid'), 
