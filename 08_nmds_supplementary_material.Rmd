...
permanova_wet <- adonis2(arthro_wet_dist ~ day+site, data = metadata_wet)
...
```{r}
plot(arthro_wet.nmds, display = 'sites', type = 'n'); points(arthro_wet.nmds, display = 'sites', pch = 20,col = ifelse(metadata_wet$day == "A", "black", "red" ));with(metadata_wet, ordihull(arthro_wet.nmds, day, draw = 'polygon', col = c('black'), label = FALSE, show.groups =(c("A"))));with(metadata_wet, ordihull(arthro_wet.nmds, day, draw = 'polygon', col = c('red'), label = FALSE,show.groups =(c("B")))); with(metadata_wet, text(arthro_wet.nmds, labels = metadata_wet$site,pos = 2, cex = 0.5))
...
```{r}
plot(arthro_dry.nmds, display = 'sites', type = 'n'); points(arthro_dry.nmds, display = 'sites', pch = 20,col = ifelse(metadata_dry$day == "A", "black", "red" )); with(metadata_dry, ordihull(arthro_dry.nmds, day, draw = 'polygon', col = c('black'), label = FALSE, show.groups =(c("A")))); with(metadata_dry, ordihull(arthro_dry.nmds, day, draw = 'polygon', col = c('red'), label = FALSE, show.groups =(c("B")))); with(metadata_dry, text(arthro_dry.nmds, labels = metadata_dry$site,pos = 2, cex = 0.5))
...
metadata_samples_wet$combined_group <- ifelse(metadata_samples_wet$methodClass %in% c("trad", "parallel"), "trad_parallel", metadata_samples_wet$methodClass)

# Plot NMDS with combined polygon for "trad" and "parallel"
plot(arthro_all_wet.nmds, display = 'sites', type = 'n')
points(arthro_all_wet.nmds, display = 'sites', pch = 20)
with(metadata_samples_wet, ordispider(arthro_all_wet.nmds, combined_group, draw = 'polygon', col = c('firebrick4'), label = FALSE, show.groups = c("trad_parallel")))
with(metadata_samples_wet, ordihull(arthro_all_wet.nmds, combined_group, draw = 'polygon', col = c('firebrick4'), label = FALSE, show.groups = c("trad_parallel")))
with(metadata_samples_wet, ordispider(arthro_all_wet.nmds, methodClass, draw =  'polygon', col = c('darkolivegreen'), label = FALSE, show.groups =(c("metabr"))))
with(metadata_samples_wet, ordihull(arthro_all_wet.nmds, methodClass, draw =  'polygon', col = c('darkolivegreen'), label = FALSE, show.groups =(c("metabr"))))
with(metadata_samples_wet, text(arthro_all_wet.nmds, labels = metadata_samples_wet$location_good, pos = 2, cex = 0.4))
...
permutation_all_dry <- adonis2(arthro_all_dry_dist ~ methodClass+location_good, data = metadata_samples_dry)
permutation_all_dry
...
metadata_samples_dry$combined_group <- ifelse(metadata_samples_dry$methodClass %in% c("trad", "parallel"), "trad_parallel", metadata_samples_dry$methodClass)

# Plot NMDS with combined polygon for "trad" and "parallel"
plot(arthro_all_dry.nmds, display = 'sites', type = 'n')
points(arthro_all_dry.nmds, display = 'sites', pch = 20)
with(metadata_samples_dry, ordispider(arthro_all_dry.nmds, combined_group, draw = 'polygon', col = c('firebrick4'), label = FALSE, show.groups = c("trad_parallel")))
with(metadata_samples_dry, ordihull(arthro_all_dry.nmds, combined_group, draw = 'polygon', col = c('firebrick4'), label = FALSE, show.groups = c("trad_parallel")))
with(metadata_samples_dry, ordispider(arthro_all_dry.nmds, methodClass, draw =  'polygon', col = c('darkolivegreen'), label = FALSE, show.groups =(c("metabr"))))
with(metadata_samples_dry, ordihull(arthro_all_dry.nmds, methodClass, draw =  'polygon', col = c('darkolivegreen'), label = FALSE, show.groups =(c("metabr"))))
with(metadata_samples_dry, text(arthro_all_dry.nmds, labels = metadata_samples_dry$location_good, pos = 2, cex = 0.4))
